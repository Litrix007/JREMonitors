...
namespace JREMonitors.BveEx.Builders
{
    ...
    public class E233_0Builder : E233BuilderBase<E233_0Config>
    {
        protected override IEnumerable<MonitorProperties> CreateMonitorProperties(
            MonitorContext context, E233_0Config vehicleConfig, DataHub dataHub)
        {
            ...
            if (vehicleConfig.Monitors.TryGetValue("1", out var m1))
                monitors.Add(new MonitorProperties(
                    ...
                    renderContext => new Screen[] { new S00AAScreen(renderContext), new MeterScreen0(renderContext) },
                    ScreenIds.Meter
                ));
            ...
            {
                return E233Screens.CreateE233Screens0(renderContext, vehicleConfig.VehicleName,
                    new[] { new TidScreen0(renderContext) });
            }
        }
    }
}