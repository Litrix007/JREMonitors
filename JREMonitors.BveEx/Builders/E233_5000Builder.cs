...
namespace JREMonitors.BveEx.Builders
{
    ...
    public class E233_5000Builder : E233BuilderBase<E233_5000Config>
    {
        protected override IEnumerable<MonitorProperties> CreateMonitorProperties(
            MonitorContext context, E233_5000Config vehicleConfig, DataHub dataHub)
        {
            ...
            if (vehicleConfig.Monitors.TryGetValue("1", out var m1))
                monitors.Add(new MonitorProperties(
                    ...
                    renderContext => new Screen[]
                        { new S00AAScreen(renderContext), new MeterScreen5000(renderContext) }, ScreenIds.Meter
                ));
            ...
            {
                return E233Screens.CreateE233Screens5000(renderContext, vehicleConfig.VehicleName,
                    new[] { new TidScreen5000(renderContext) });
            }
        }
    }
}