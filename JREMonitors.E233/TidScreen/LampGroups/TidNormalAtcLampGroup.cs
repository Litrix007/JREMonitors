...
namespace JREMonitors.E233.TidScreen.LampGroups
{
    public class TidNormalAtcLampGroup : TidLampGroupBase<NormalAtcViewModel>
    {
            ...
            base(context)
        {
            ...
            var row1Bounds = new RectangleF(AnchorX, y, TidScreens.WideRowWidth, TidScreens.WideRowHeight);
            var row1 = Row.FromBounds(context, row1Bounds, TidScreens.WideLampSpacing, row1Children, 0.5f);
            AddChild(row1);
            ...
            var row2Bounds = new RectangleF(AnchorX,
                y + TidScreens.WideRowHeight + TidScreens.WideRowSpacing,
                TidScreens.WideRowWidth, TidScreens.WideRowHeight);
            var row2 = Row.FromBounds(context, row2Bounds, TidScreens.WideLampSpacing, row2Children, 0.5f);
            AddChild(row2);
        }
